...
- Kept one unified wallet-card layout across mobile and desktop.
- Simplified Recent Stops to location-only pills.
- Removed dates and trip titles from Recent Stops.
- Added four recent Tripsy-derived locations:
  - Béziers
  - London
  - Upton upon Severn
  - North Yorkshire
- Preserved the compact v24 proportions.
- Build timestamp: 2026-07-14T17:37:44Z
